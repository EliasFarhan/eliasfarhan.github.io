...
Two weeks ago, I announced that my talk was accepted for CppCon 2026, happening in about a month in Denver (on Tuesday, September 15th, to be more exact). The talk is about building a small but non-trivial C++ game engine and all the nice things modern C++ provides to help with this task. I was not very comfortable with giving a purely theoretical talk without any practical example to back it up. You can find it in the CppCon schedule [here](https://cppcon2026.sched.com/event/2RT5K/inside-a-small-game-engine-an-architecture-tour-in-modern-c++).
...
- (2) Porting from Unity to Neko3d
- (3) The asset compiler
- (4) Profiling with Tracy
- (5) Level load time
- (6) Rendering optimization: culling, cutout silhouettes and depth sharing
